...
workersInfo = [('Иван', 'Иванов', 'Иванович', 'Директор'),
               ('Денис', 'Денисов', 'Денисович', 'Системный администратор'),
...
# Прощальное письмо
print('Создание и заполнение таблиц И БД прошло успешно!\nПока у вас существует БД workersPosition.db этот файл перезапускать не надо')
